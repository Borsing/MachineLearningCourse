...
%set y as binary vector
ry = ([1:num_labels] .* ones(m,num_labels)) == y ;
ry = ry' ;
...
%cost function
J = (1/m) * sum(sum((-ry .* log(ho)) - (( 1 - ry) .* log(1-ho)))) ;

%remove first column correspond to bias unit
...
%STEP 1
%a1 = X  ;                                %(5000 * 401)
%a2 = [ones(1,m),sigmoid(Theta1 * X')] ;  %(26  * 5000)
%a3 = ho = sigmoid(Theta2 * a2)        ;  %(10  * 5000)

%STEP 2
%output layer 10 * 5000
delta3 = ho - ry ; 

%STEP 3 
%hidden layer 25 * 5000
z2 = Theta1 * X' ;
